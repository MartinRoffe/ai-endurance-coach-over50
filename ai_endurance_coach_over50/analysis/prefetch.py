...
_STEP_SUMMARIES: dict[str, str] = {
    ...
    "Structured Z2":    "10m warm-up → 2 × 20m Z2 with 5m easy between → 5m cool-down",
    "Hill Repeats":     "15m warm-up → 5 × (3m Z4–5 hill effort + 3m Z1 descent) → 15m cool-down",
    "Sweetspot Ride":   "15m warm-up → 3 × 12m at 88–93% FTP with 5m Z2 between → Z2 fill → cool-down (90m)",
    "Sweetspot Intervals": "15m warm-up → 3 × 12m at 88–93% FTP with 5m Z2 between → Z2 fill → cool-down (90m)",
    "Over-Unders":      "15m warm-up → 2 sets × [4 × (2m @105% / 2m @95% FTP)], 5m Z1 between → Z2 fill → cool-down (75m)",
    "Threshold Ride":   "15m warm-up → 2 × 20m at 95–100% FTP with 8m Z2 between → Z2 fill → cool-down (90m)",
    "Low Cadence Ride": "10m warm-up → 4 × 8m at 60–65 rpm (88–94% FTP) with 3m Z1 between → Z2 fill → 10m cool-down (75m)",
    ...
    "Cadence Drills":   "10m warm-up → 4 × 5m at 95–100 rpm with 3m normal cadence between → Z2 fill → 10m cool-down",
    ...
    "Tempo Intervals":  "15m warm-up → 3 × 10m at Z3 (76–88% FTP) with 5m Z1 between → Z2 fill → cool-down (75m)",
    "Long Ride":        "15m warm-up → sustained Z2 main block → 15m cool-down",
    "Long Ride (Easy)": "15m warm-up → easy Z1–2 riding → 15m cool-down",
    "Pre-Event Long Ride": "15m warm-up → sustained Z2 main block → 15m cool-down",
